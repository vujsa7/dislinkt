package com.dislinkt.postservice.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.dislinkt.postservice.controller..*)" +
            " || within(com.dislinkt.postservice.dao..*)" +
            " || within(com.dislinkt.postservice.service..*)")
    public void applicationPackagePointcut(){}

    @Pointcut("!@annotation(com.dislinkt.postservice.logging.NoLogging)")
