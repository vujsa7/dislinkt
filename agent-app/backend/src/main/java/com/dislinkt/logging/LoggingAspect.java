...
public class LoggingAspect {
    ...
    @Pointcut("within(com.dislinkt.auth.controller..*)" +
            " || within(com.dislinkt.auth.dao..*)" +
            " || within(com.dislinkt.auth.service..*)" +
            " || within(com.dislinkt.user.controller..*)" +
            " || within(com.dislinkt.user.dao..*)" +
            " || within(com.dislinkt.user.service..*)"+
            " || within(com.dislinkt.verification.token.controller..*)" +
            " || within(com.dislinkt.verification.token.dao..*)" +
            " || within(com.dislinkt.verification.token.service..*)")
    public void applicationPackagePointcut() {
    }

    @Pointcut("!@annotation(com.dislinkt.logging.NoLogging)")
